 ...
 * 
 * After startup this code sends a udp packaeg and then trys to pull down CH_PD at the end of the scetch to disable the microchip.
 * 
 */
...
#define POWER_PIN 14  //D5 needs to be conected to the EN Pin 
...
void loop() {  
  digitalWrite(POWER_PIN, LOW); // should never reach this, but just for good measure
